...
public class NoDefaultConstructorExternalizedObject implements Externalizable {

	private String string;
	private Integer integer;
	private transient long transientLong;

	public NoDefaultConstructorExternalizedObject(final String string) {
		this.string = string;
	}

	public NoDefaultConstructorExternalizedObject(final Integer integer) {
		this.integer = integer;
	}

	public NoDefaultConstructorExternalizedObject(final String string, final Integer integer) {
		this.string = string;
		this.integer = integer;
	}
